...
class PayStreettextBase extends StatelessWidget {
  const PayStreettextBase(
      this.text, {
        this.style,
...
class TextBody extends PayStreettextBase {
  TextBody(
      String super.text, {
        super.key,
        TextStyle? style,
...
class H1 extends PayStreettextBase {
  H1(
      String super.text, {
        super.key,
        Color? color,
...
class TextBold extends PayStreettextBase {
  TextBold(
      String super.text, {
        super.key,
        TextStyle? style,
...
class TextSemiBold extends PayStreettextBase {
  TextSemiBold(
      String super.text, {
        super.key,
        TextStyle? style,
...
class TextSmall extends PayStreettextBase {
  TextSmall(
      String super.text, {
        double fontSize = 12,
        super.key,
